...
part of 'movie_videos_remote_data_source.dart';
...
class _MovieVideosRemoteDataSource implements MovieVideosRemoteDataSource {
  _MovieVideosRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
