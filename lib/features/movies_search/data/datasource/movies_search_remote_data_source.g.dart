...
part of 'movies_search_remote_data_source.dart';
...
class _MoviesSearchRemoteDataSource implements MoviesSearchRemoteDataSource {
  _MoviesSearchRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
