...
class _MovieDetailsRemoteDataSource implements MovieDetailsRemoteDataSource {
  ...
  Future<MovieVideosModel> getMovieVideos(int movieId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MovieVideosModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<MovieCreditsModel> getMovieCredits(int movieId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MovieCreditsModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          'movie/${movieId}/credits?api_key=0c0c7744db435d591d976e6422a9ef8e',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
